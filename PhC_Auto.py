...
from PySide6.QtCore import (QCoreApplication, QRegularExpression, QMetaObject, QRect)
...
class UiPhaseCenter1(QMainWindow):
    ...
    def setup_ui(self, phase_center):
        ...
        self.comboBox_unit.setGeometry(
            QRect(10, 50 + 3 * comboBoxHeight - 10 + 5 + 16 - 2, comboBoxWidth, comboBoxHeight))
    ...
    def retranslate_ui(self, phase_center):
        ...
        self.label_unit.setText(QCoreApplication.translate("phase_center", u"Unit", None))
        self.label_Polarization.setText(QCoreApplication.translate("phase_center", u"Polarization", None))
        self.label_pcv.setText(QCoreApplication.translate("phase_center", u"PCV", None))
        ...
        self.label_PhC.setText(QCoreApplication.translate("phase_center", u"Phase Center Location", None))
    ...
    def auto_create_rel_cs(self, setup):
        ...
        oMod.ExportParametersToFile(
            [
                "ExportFileName:=", cwd+"\\ e xportparams2.txt",
        ...
        cs1 = self.hfss.modeler.create_coordinate_system(name=relative2pccs_auto_name,
                                                         origin=["0"+unit, "0"+unit, "0"+unit], reference_cs=pccsname)
        cs1.change_cs_mode(mode)
        cs1.props["Phi"]=euler_phi
        cs1.props["Theta"]=euler_theta
        cs1.props["Psi"]=euler_psi
        ZYZ_rel = [euler_phi, euler_theta, euler_psi]  # [e  ler_psi,euler_theta,euler_phi]
        ...
        self.plotwidget.plot(cut_data_phi0.primary_sweep_values, cut_data_phi0.data_phase(radians=False),
                             ...
                             name=cutplane + "=" + "0" + "deg" + " | " + "PhC_" + current_freq + " | \u03C3=" + str(
                                 "{:.2f}".format(np.std(cut_data_phi0.data_phase(radians=False)))))
        self.numCurves += 1
        return PhC_wrt_global
